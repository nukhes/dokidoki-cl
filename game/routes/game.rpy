label game:
    ...
    menu:
        "Escolher Indiano":
            $ chosen = "s"
            call indiano_lab from _call_indiano_lab

        "Escolher Mikael":
            $ chosen = "m"
            call mikael_lab from _call_mikael_lab
...
label dia_2:
    ...
    menu:
        "Escolher Mikael":
            if chosen != "m":
                call marquinhosbadendgame_indiano from _call_marquinhosbadendgame_indiano
            else:
                call mikael_choice from _call_mikael_choice

        "Escolher Indiano":
            if chosen != "s":
                call marquinhosbadendgame_mikael from _call_marquinhosbadendgame_mikael
            else:
