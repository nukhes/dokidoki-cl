...
define config.name = "Doki Doki Chemistry Lab"
...
define config.save_directory = "dd-chemistry-lab"
...
init python:
    ...
    build.package(build.directory_name + "",'zip',build.name,description='Doki Doki Chemistry Lab')
